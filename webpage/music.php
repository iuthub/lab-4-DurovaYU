		...
		<div id="listarea">
			<ul>
				...
				<li class="playlistitem">
					<a href="music.php?playlist=190M Mix.txt"><?=basename($playlists[0])?></a>
				</li>

				<li class="playlistitem">
					<a href="music.php?playlist=mypicks.txt"><?=basename($playlists[1])?></a>
				</li>

				<li class="playlistitem">
					<a href="music.php?playlist=playlist.txt"><?=basename($playlists[2])?></a>
				</li>
			</ul>
		</div>
	</body>
